                                    ...
                                    <div className="grid grid-cols-3 gap-x-4 gap-y-2">
                                      {mainCategories && mainCategories.length > 0 ? mainCategories.map((mainCat, idx) => (
                                        <div key={mainCat.mainCategory} className="mb-4">
                                          <div className="font-semibold text-xl text-sky-700 mb-2">{mainCat.mainCategory}</div>
                                            ...
                                            <div key={category.slug} className="mb-2">
                                              <div className="flex items-center gap-1">
                                                ...
                                                <Link
                                                  ...
                                                  className={`flex items-center gap-2 py-2 px-2 rounded-lg transition-all duration-200 flex-1 ${activeCategory === category.slug
                                                    ? 'text-sky-700 font-bold bg-sky-50'
                                                    : 'text-gray-700 font-bold hover:text-sky-600 hover:bg-sky-50/50'
                                                    }`}
                                                >
                                                  <span
                                                    className={`relative w-1.5 h-1.5 rounded-full ${activeCategory === category.slug ? 'bg-sky-500' : 'bg-gray-400'
                                                      }`}
                                                  >
                                                    <span className={`
                                                      absolute -bottom-1 left-1/2 transform -translate-x-1/2
                                                      w-3 h-0.5 rounded-full ${activeCategory === category.slug ? 'bg-gray-800' : 'bg-transparent'
                                                      }
                                                    `} />
                                                  </span>
                                                  {category.name}
                                                    ...
                                                    >
                                                      {category.subCategories.map((subCategory) => (
                                                        <Link
                                                          ...
                                                          className={`block px-3 py-2 rounded-md text-sm transition-all duration-200 ${activeCategory === category.slug && activeSubCategory === subCategory.id
                                                            ? 'text-sky-700 font-medium bg-sky-100'
                                                            : 'text-gray-600 hover:text-sky-600 hover:bg-sky-50'
                                                            }`}
                                                        >
                                                          <div className="flex items-center gap-2">
                                                            <span className={`text-xs ${activeCategory === category.slug && activeSubCategory === subCategory.id
                                                              ? 'text-sky-500'
                                                              : 'text-gray-300'
                                                              }`}>
                                          ...
                                          <div className="ml-6 mt-2 space-y-2">
                                            {consumable.items.map((item) => (
                                              <Link
                                                ...
                                                className={`block px-3 py-2 rounded-md text-sm transition-all duration-200 ${activeCategory === consumable.slug && activeSubCategory === item.slug
                                                  ? 'text-sky-700 font-medium bg-sky-100'
                                                  : 'text-gray-600 hover:text-sky-600 hover:bg-sky-50'
                                                  }`}
                                              >
                                                <div className="flex items-center gap-2">
                                                  <span className={`w-1 h-1 rounded-full ${activeCategory === consumable.slug && activeSubCategory === item.slug
                                                    ? 'bg-sky-500'
                                                    : 'bg-gray-300'
                                                    }`} />
                                                  {item.name}
