    ...
    return (
        ...
        >
                ...
                <div className="w-full lg:w-1/4 bg-gray-800 px-10 -mt-3 pt-3 rounded-lg space-y-2">
                    ...
                    <div className="flex justify-center lg:justify-start space-x-3 mt-4">
                        {socialIcons.map(({ Icon, href }, index) => (
                            <a key={index} href={href} className="p-2 bg-white text-black rounded-lg hover:bg-[#0f7db7] hover:text-white transition transform hover:scale-110 shadow-md">
                                <Icon size={20} />
                            </a>
                        ))}
                    </div>
            ...
            <div className='relative pt-12 text-center text-gray-300'>
                © 2025 <span className='hover:text-[#0f7db7]'><a href="/#">Metatech Industries</a></span>.
